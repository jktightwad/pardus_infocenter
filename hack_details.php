...
<body>
    ...
    <?php if ($hack["turnover"]):?>
    <tr>
        <th colspan="3">Turnover</th>
    </tr>
    <tr>
        <td colspan="3" align="center"><?php echo(number_format($hack["turnover"]))?></td>
    </tr>
    <?php endif;?>
        ...
        <?php if ($hack["contacts"]):?>
            <td align="center" valign="top" width="50%">
                <table style="background-color: rgb(0, 72, 0);" align="center">
                    <tbody>
                    <tr>
                        <th>contacts info of target</th>
                    </tr>
                    <?php if ($hack["contacts"]):?>
                        <?php foreach ($hack["contacts"] as $contacts):?>
                            <tr>
                                <td><a href="javascript:sendmsg('<?php echo($contacts)?>')"><?php echo($contacts)?></a></td>
                            </tr>
                        <?php endforeach;?>
                    <?php endif;?>
                    </tbody>
